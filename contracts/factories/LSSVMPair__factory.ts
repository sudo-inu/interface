...
import type { LSSVMPair, LSSVMPairInterface } from "../LSSVMPair";
...
export class LSSVMPair__factory {
  static readonly abi = _abi;
  static createInterface(): LSSVMPairInterface {
    return new utils.Interface(_abi) as LSSVMPairInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LSSVMPair {
    return new Contract(address, _abi, signerOrProvider) as LSSVMPair;
  }
}
