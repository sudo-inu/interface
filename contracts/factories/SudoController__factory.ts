...
const _abi = [
  ...
  },
  {
    ...
    name: "takeBack__REMOVE_BEFORE_SHIP",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class SudoController__factory {
  static readonly abi = _abi;
  static createInterface(): SudoControllerInterface {
    return new utils.Interface(_abi) as SudoControllerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SudoController {
    return new Contract(address, _abi, signerOrProvider) as SudoController;
  }
}
